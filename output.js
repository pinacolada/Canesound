...
function btnCmd(b) {
    ...
    switch (b.name) {
        case "Clear":
            draw.forEach(t => t.remove());
            draw = [];
            break;
        case "Line":
            draw.push(new LineTool(stage, next.x, next.y, toolLineStyle, showCurrentTool));
            break;
        case "Curve":
            draw.push(new CurveTool(stage, next.x, next.y, toolLineStyle, showCurrentTool));
            break;
        case "Cubic":
            draw.push(new CubicTool(stage, next.x, next.y, toolLineStyle, showCurrentTool));
            break;
        case "Rect":
            draw.push(new RectTool(stage, next.x, next.y, toolFillStyle, toolLineStyle, showCurrentTool));
            break;
        case "Circle":
            draw.push(new CircleTool(stage, next.x, next.y, toolFillStyle, toolLineStyle, showCurrentTool));
            break;
        case "Ellipse":
            draw.push(new EllipseTool(stage, next.x, next.y, toolFillStyle, toolLineStyle, showCurrentTool));
            break;
        case "Polyline":
            draw.push(new PolylineTool(stage, next.x, next.y, toolLineStyle, showCurrentTool));
            break;
        case "Polygon":
            draw.push(new PolygonTool(stage, next.x, next.y, toolFillStyle, toolLineStyle, showCurrentTool));
            break;
        case "Load":
            ;
            break;
